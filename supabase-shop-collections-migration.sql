-- Safe additive migration for editable SHIPS collections.
-- This does not update or delete any existing shop_items rows.
...
select 'shop collections added successfully; existing items were not changed' as result;
